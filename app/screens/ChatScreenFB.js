...
import ChatHeaderFB from "../components/Header/ChatHeaderFB";
...
export default function ChatScreenFB({ route, navigation }) {
	...
	return (
		<Screen style={styles.background}>
			<ChatHeaderFB navigation={navigation} username={username} profile_pic={profile_pic} />
